<template>
  <div class="table-container f-cb">
    <table class="grid">
      <table-header :columns="columns" key="column.tag" :curSortColumn="curSortColumn" :sortOrder="sortOrder"
                    :isSelectAll="selectRows.length==tabledata.length" @sortColumn="updateColSort"
                    @selectAll="selectAll"/>
      <table-body :rows="tabledata" :columns="columns" :keyTag="keyTag" :curSortColumn="curSortColumn"
                  :sortOrder="sortOrder" :enableSelected="enableSelected" :selectRows="selectRows" key="index"
                  @selectRowsChange="selectRowsChange"/>
    </table>
    <pagination :total="total" :pageSizeList="pageSizeList" @getPageData="getPageData" v-show="pageable"></pagination>
